...
module Hello.Tests.Platforms.NucleoF722 where
...
import Ivory.BSP.STM32F722
import Ivory.BSP.STM32F722.Clock
...
-- with 4.3 pF caps
nucleo_f722_hse_cc :: ClockConfig
nucleo_f722_hse_cc =
  ClockConfig {
...
nucleo_f722_hsi_cc :: ClockConfig
nucleo_f722_hsi_cc =
  ClockConfig {
...
nucleo_f722 :: Platform
nucleo_f722 = Platform {
    platformClocks   = nucleo_f722_hsi_cc
  , platformMCU      = Nothing
  , platformMCUName  = "STM32F722ZET6"
  , platformPin      = pinB14
